...
extern "C" JNIEXPORT void JNICALL Java_com_example_PROJECTNAME_Firebird_initAPI(JNIEnv *env, jobject self){core = Firebird::Core(env);} ///< Init the Core class
...
namespace Firebird {
    ...
    extern "C" JNIEXPORT jint JNICALL Java_com_example_PROJECTNAME_Firebird_getApiVersion(JNIEnv* env, jobject self) {return FB_VERSION;} ///< @return version of api
     ...
     */
    extern "C" JNIEXPORT void JNICALL Java_com_example_PROJECTNAME_Firebird_connect(JNIEnv* env, jobject self, jstring databaseName, jstring user, jstring pass)
    {
     ...
     * @throw Firbird::exception
     */
    extern "C" JNIEXPORT void JNICALL Java_com_example_PROJECTNAME_Firebird_disconnect(JNIEnv* env, jobject self)
    {
        try {core.disconnect();}
        catch (...) {jniRethrow(env);}
    }
     ...
     * @throw Firbird::exception
     */
    extern "C" JNIEXPORT jobjectArray JNICALL Java_com_example_PROJECTNAME_Firebird_executeReqC(JNIEnv* env, jobject self, jstring req, jobjectArray inJavaData)
    {
        try {
#if 1
